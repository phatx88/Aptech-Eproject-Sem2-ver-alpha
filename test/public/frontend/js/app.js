    ...
    "features": [
        {
            ...
            "properties": {
                "category": "liquor",
                "hours": "10am - 6pm",
                "description": "Stylized liquor and wine shop featuring a variety of imported brands of distilled beverage.",
                "name": "LiquoreStore.com",
                "phone": "+84 703060969",
                "storeid": "01"
            }
        },
...
function initMap() {
    ...
    const map = new google.maps.Map(document.getElementById('map'), {
        zoom: 13,
        center: { lat: 10.7961525, lng: 106.6983326 },
        styles: mapStyle,
    });

    // Load the stores GeoJSON onto the map.
    map.data.addGeoJson(tempObject, { idPropertyName: 'storeid' });

    // Define the custom marker icons, using the store's "category".
    map.data.setStyle((feature) => {
        return {
            icon: {
                url: `frontend/images/icon_${feature.getProperty('category')}.png`,
                scaledSize: new google.maps.Size(32, 32),
            },
        };
    });

    const apiKey = 'AIzaSyCwww3EMQjptptBrloFxaIYJFGkQkuWLLE';
    ...
    map.data.addListener('click', (event) => {
        ...
        const content = `
      <img style="float:left; width:200px; margin-top:30px" src="frontend/images/kind-5.jpg">
