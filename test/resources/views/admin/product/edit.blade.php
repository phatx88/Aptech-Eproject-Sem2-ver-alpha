        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('admin.product.update' , ['product' => $product]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="product_name" id="name" type="text" value="{{ $product->name }}" class="form-control @error('product_name') is-invalid @enderror" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-md-12 control-label" for="wholesale-price">Price </label>
                    <div class="col-md-9 col-lg-6">
                        <input name="price" id="wholesale-price" type="number" min="0" value="{{ $product->price }}" class="form-control @error('price') is-invalid @enderror" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="inventory_qty" id="inventory-number" type="number" min="0" value="{{ $product->inventory_qty }}" class="form-control @error('inventory_qty') is-invalid @enderror" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="discount_percentage" id="discount_percentage" type="number" value="{{ $product->discount_percentage }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="discount_from_date" id="discount_from_date" type="date" value="{{ $product->discount_from_date }}" class="form-control @error('discount_from_date') is-invalid @enderror">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9 col-lg-6">
                        <input name="discount_to_date" id="discount_to_date" type="date" value="{{ $product->discount_to_date }}" class="form-control @error('discount_to_date') is-invalid @enderror">
                    </div>
                </div>
